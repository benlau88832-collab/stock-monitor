...
// ============================================================
// v9.143.0（决策动作先确认后落库 + 产业链共享化 + 舆情/主线降级修复）：
// v9.142.0（#11 推送分层·持仓优先 + 引擎单源化）：
...
// v9.148.0（产业链主动投研引擎 12 任务）：AI 思考模式修复（agentReason 恒思考）/PROXY_AGENT 导出修复/
//   webSearch 外网搜索层（Google News RSS 经代理+HN 备源+权威判定）/chainStocks 6 链×336 只/
...
//   GitHub main 快进同步
// v9.150.0（P2 剩余收口）：外部统计口径真实落库（PMI/CPI/PPI/工业增加值/固投/海关，每日 07:40 刷新）+
//   基本面研报覆盖趋势（东财 reportapi 按月聚合）+ FundamentalCard/链简报展示 + 专项单测
export const APP_VERSION = "v9.150.0";
