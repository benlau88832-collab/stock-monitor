...
export default function AIConsole({ siteContext }: { siteContext: AssistantSiteContext }) {
  ...
  return (
    <>
      ...
      {open && (
        <div className="fixed bottom-20 right-5 z-50 flex h-[480px] w-[380px] flex-col rounded-2xl border border-violet-500/30 bg-[#0b0f1a]/95 shadow-2xl shadow-black/50 backdrop-blur-md">
