  ...
  return (
    <>
      <nav className="sticky top-0 z-50 border-b border-white/10 bg-[#0b0f1a]/95 backdrop-blur-md">
        <div className="mx-auto flex max-w-[1500px] items-center justify-between gap-2 overflow-x-auto px-4 py-2">
          <div className="flex items-center gap-2">
            ...
            <div className="hidden sm:block">
              <div className="text-sm font-bold text-slate-100 leading-tight">波段作战系统</div>
              <div className="text-[11px] text-slate-500">方向 · 持仓逻辑 · 决策 · 复盘</div>
            </div>
          </div>
